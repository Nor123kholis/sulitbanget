		...
		<table class="table table-hover table-sm">
			...
			foreach ($result as $row ) { ?>
				<tr>
					...
					<td><?= $row['nama_merk']; ?></td>
					<td>
						<a  href="edit.php?id_merk=<?= $row['id_merk']  ?>" class="btn btn-warning btn-sm">Ubah</a>
						<a  href="../../controller/merk_produk/delete.php?id_merk=<?= $row['id_merk']  ?>" class="btn btn-danger btn-sm">Hapus</a>
