...
$query="UPDATE beli SET nama_produk='$nama_produk', id_kategori='$kategori_produk', warna='$warna_produk', id_merk= '$merk_produk', total_harga='$total_harga', pembeli='$pembeli' WHERE id_beli ='$id_beli'";
