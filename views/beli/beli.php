      ...
      <div class="card-body">
        <form action="../../controller/transaksi/tuku.php" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-sm" name="pembeli" placeholder="Masukkan Nama anda" required>
          </div>
          <button type="submit" class="w-100 btn btn-sm btn-success">Beli</button>
        </form>
      </div>
    </div>
